...
<view class="zone" bindtap="toggle">
...
<view class="pop" bindtap="toggle">
  <view class="pop-root">
    <view class="pop-content" style="margin-left:{{popMargin}}"></view>
    <view class="pop-mask" style="opacity:{{opacity}};display:{{show}}" bindtap="toggle"></view>
  </view>
</view>